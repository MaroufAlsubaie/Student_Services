    ...
    <body>
        ...
        <div class="item">
            <div class="container2">
                <div class="row">
                    <div class="col-4">
                       <img src="images/الاتصالات المتنقلة pdf عملي.jpg" class="item-img">     
                    </div>
                    <div class="col-4">
                        <h1>الاتصالات المتنقلة‎</h1>
                        <h4>40.0 ريال</h4>
                        <input type="number" value="1">
                        <a href="" class="bottun">اضف الى السلة</a>                        
                        <p>من الكاتب بينجامين سبول و مايكل زاندر<br>ترجمة متعب فهد الشمري</p>
                    </div>
                </div>
            </div>
        </div>
